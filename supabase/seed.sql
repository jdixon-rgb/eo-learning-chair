...
-- ── SAPs ──
insert into public.saps (id, chapter_id, name, company, role, description, contribution_type, contribution_description, notes) values
  ('30000000-0000-4000-a000-000000000001', '00000000-0000-4000-a000-000000000001', 'Jamie Osborn', 'Culture Index', 'Strategic Alliance Partner', 'Culture Index provides behavioral analytics for leadership teams. Jamie runs interactive workshops analyzing attendees'' behavioral profiles.', 'workshop', 'Culture Index Workshop - attendees take the Culture Index survey in advance, Jamie presents high-level group analysis and individual insights live.', 'Tied to February event at Wrigley Mansion alongside Dr. Gary Chapman. Culture Index + 5 Love Languages = powerful combination for understanding relationships at home and work.')
on conflict (id) do nothing;
...
insert into public.events (id, chapter_id, title, event_date, event_time, month_index, event_type, event_format, strategic_importance, status, speaker_id, candidate_speaker_ids, sap_ids, venue_id, day_chair_name, day_chair_phone, expected_attendance, notes, theme_connection) values
  ...
  ('40000000-0000-4000-a000-000000000007', '00000000-0000-4000-a000-000000000001', 'RELATIONSHIPS: The 5 Love Languages', '2027-02-02', '18:00', 6, 'traditional', 'workshop_4hr', 'renewal_critical', 'planning', '20000000-0000-4000-a000-000000000008', '{20000000-0000-4000-a000-000000000008}', '{30000000-0000-4000-a000-000000000001}', '10000000-0000-4000-a000-000000000007', '', '', 100, 'RENEWAL MONTH - critical for retention. Dr. Gary Chapman at The Wrigley Mansion. SAP Tie-In: Culture Index (Jamie Osborn workshop). Unexpected: Jesse Palmer from The Bachelor. Interactivity: Rose Ceremony + Culture Index Analysis.', 'RELATIONSHIPS - Marriage can be a challenge. But if you treat EVERY DAY like a gift, an opportunity to start fresh, you can make meaningful progress toward restoring and building one of the most important relationships in your life.'),
