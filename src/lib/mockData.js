...
export const mockSAPContacts = [
  // Platinum
  { id: 'sc-laux', sap_id: 'sap-silverhawk', name: 'Joe Laux', role: 'Managing Partner', email: 'joe.laux@silverhawk.example.com', phone: '', is_primary: true, forum_trained: true, forum_trained_date: '2025-03-15', notes: '', created_at: new Date().toISOString(), updated_at: new Date().toISOString() },
  ...
  { id: 'sc-gardner', sap_id: 'sap-quarles', name: 'Jeff Gardner', role: 'Partner', email: 'jeff.gardner@quarles.example.com', phone: '', is_primary: true, forum_trained: true, forum_trained_date: '2024-11-08', notes: '', created_at: new Date().toISOString(), updated_at: new Date().toISOString() },
  ...
  { id: 'sc-erath', sap_id: 'sap-nextlevel', name: 'Michael Erath', role: 'Founder', email: 'michael@nextlevelgrowth.example.com', phone: '', is_primary: true, forum_trained: false, forum_trained_date: null, notes: '', created_at: new Date().toISOString(), updated_at: new Date().toISOString() },
...
export const mockEvents = [
  {
    ...
    sap_ids: ['sap-silverhawk', 'sap-quarles', 'sap-nextlevel'],
  ...
  },
  {
    ...
    sap_ids: ['sap-silverhawk', 'sap-heartland'],
  ...
  },
  {
    ...
    sap_ids: ['sap-silverhawk', 'sap-nextlevel', 'sap-aptive'],
