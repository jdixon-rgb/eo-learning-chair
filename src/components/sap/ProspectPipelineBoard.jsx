...
// Prospect Kanban — five columns (Lead → Contacted → Meeting →
// Negotiating → Signed). Cards advance with arrow buttons; on the
// final column a Promote button graduates them to status='active'
...
export default function ProspectPipelineBoard() {
  ...
  const promote = (sapId) => {
    if (!window.confirm('Promote this prospect to an active SAP partner? They will appear in the Active board.')) return
