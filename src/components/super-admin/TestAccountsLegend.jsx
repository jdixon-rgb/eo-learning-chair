...
import { TestTube2, Send, Loader2, Check } from 'lucide-react'
  ...
  return (
    <div className="rounded-xl border-2 border-amber-300 bg-amber-50 p-5 shadow-sm">
      <div className="flex items-start gap-3 mb-3">
        <TestTube2 className="h-5 w-5 text-amber-700 mt-0.5" />
        <div>
          <h3 className="font-semibold text-amber-900">Test Accounts ({env})</h3>
